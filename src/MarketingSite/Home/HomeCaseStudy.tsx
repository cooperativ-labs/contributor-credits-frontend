  ...
  <>
    <div>
      <h1 className={bigTitleClass} style={{ textShadow: '3px 3px 5px #e2e2e2' }}>
        HoopUp uses Cooperativ to share success.
      </h1>
...
const HomeCaseStudy: React.FC<any> = ({ projects }) => {
  return (
    <StandardSection divider backgroundColor="#F4F1EC">
      <h1 className="mb-8 md:text-xl text-cDarkBlue font-semibold">Case Study</h1>
